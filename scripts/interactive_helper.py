...
def show_important_notes():
    ...
    print("-" * 80)
    print("  Le traitement audio utilise la bibliothèque soundfile (libsndfile):")
    print()
    print("  ✅ Aucun outil externe requis")
    print("  ✅ Tout est géré par les bibliothèques Python")
    print("  ✅ Installation simple via pip")
    print()
