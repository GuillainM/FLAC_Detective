"""Script de démonstration du rapport texte."""
...
demo_results = [
    {
        ...
        "score": 100,
        "reason": "Spectre complet, énergie HF excellente",
        "cutoff_freq": 22050,
    ...
    },
    {
        ...
        "score": 20,
        "reason": "Coupure 16kHz (MP3 128kbps transcode)",
        "cutoff_freq": 16000,
        "duration_mismatch": False,
    },
    {
        ...
        "score": 65,
        "reason": "Énergie HF faible, suspect",
        "cutoff_freq": 18500,
    ...
    },
    {
        ...
        "score": 35,
        "reason": "Coupure 16kHz + métadonnées suspectes (LAME)",
        "cutoff_freq": 16000,
        "duration_mismatch": True,
        "duration_diff": 1500,
    },
...
print(f"✅ Rapport de démonstration généré : {output_file}")
print("\nContenu du rapport :\n")
print("=" * 100)
